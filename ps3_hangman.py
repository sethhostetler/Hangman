...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    for char in guessWord:
        if char not in lettersGuessed:
            guessWord = guessWord.replace(char, '_ ')
    return guessWord
...
#wordLength = raw_input('How many letters do you want to guess?')
#while len(secretWord) is not wordLength:
#     secretWord = chooseWord(wordlist).lower()
# secretWord = 'thequickbrownfoxjumpsoverthelazydog'
hangman(secretWord)
